...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl">
            <a class="logo navbar-logo f-l mr-10 hidden-xs" href="{{route('admin.index')}}">小P管理系统</a>
        ...
        <dl id="menu-admin">
            ...
            <dd>
                <ul>
                    ...
                    <li><a data-href="{{route('admin.permission.index')}}" data-title="权限管理" href="javascript:void(0)">权限管理</a></li>
